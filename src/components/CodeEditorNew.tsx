...
export default function CodeEditor({ session }: CodeEditorProps) {
    ...
    return (
        <div className="h-screen bg-[#1e1e1e] text-white flex flex-col">
            {/* Top Header Bar with Codeer IDE branding */}
            ...
            <div className="h-12 bg-[#2d2d30] border-b border-[#3e3e42] flex items-center justify-between px-4">
                ...
                {/* Right side - Run button and AI toggle */}
                <div className="flex items-center space-x-3">
                    <Button
                        onClick={executeCode}
                        disabled={isRunning}
            ...
            <div className="flex-1 flex min-h-0">
                {/* Code Editor Section */}
                <div className={`${isAiEnabled ? 'flex-1' : 'flex-[2]'} bg-[#1e1e1e] flex flex-col`}>
                ...
                <div className="w-80 bg-[#1e1e1e] border-l border-[#2d2d30] flex flex-col">
                    {/* Input/Output Header */}
                        ...
                        {activeTab === 'input' ? (
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-48 bg-[#2d2d30] border border-[#3e3e42] text-white placeholder-gray-400 p-3 rounded text-sm font-mono resize-none"
                                    />
                                </div>
                            </div>
                        ) : (
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <div className="w-full h-48 bg-[#2d2d30] border border-[#3e3e42] text-white p-3 rounded text-sm font-mono overflow-y-auto whitespace-pre-wrap">
